package telran.tools.numbers.test;

import static org.junit.jupiter.api.Assertions.*;

import static telran.tools.numbers.Calculations.*;
...
import telran.tools.numbers.Calculations;
...
class CalculatorTests {
  ...
  @Test
  void testSubtract() {
    assertEquals(10, Calculations.substract(op1, op2));
    assertEquals(11, Calculations.substract(op1, op2Negative));
    assertEquals(-10, substract(op1Negative, op2Negative));
  }
